...
public class MXP_IMU extends Subsystem {
	...
	public MXP_IMU() {
		...
		try {
			...
			//Use SPI.Port.kMXP if connecting navX MXP to the RoboRio MXP port
	        spi_port = SPI.Port.kMXP;
	        
//	    	serial_port = new SerialPort(57600,SerialPort.Port.kMXP);
			if (spi_port == null)
				System.out.println("**** SPI port is null :-\\");
			else
				System.out.println("**** SPI port is good!");
			...
			imu = new AHRS(spi_port,update_rate_hz);
